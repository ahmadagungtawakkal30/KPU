                ...
                <div class="box">
                    <article class="media">
                        <div class="media-content">
                            <div class="content">
                                <p>
                                    <strong>{{ data_user.npm }}</strong> <small>{{ data_user.nama }}</small>
                                    <br>
                                    {{ data_user.email }}
                                    <br>
                        ...
                        <a class="text-white" href="{% url 'sendmail' email=data_user.email npm=data_user.npm nama=data_user.nama %}">
